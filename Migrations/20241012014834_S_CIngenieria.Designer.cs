...
namespace S_CIngenieria.Migrations
{
    ...
    [Migration("20241012014834_S_CIngenieria")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("S_CIngenieria.Models.GestionContratos.Actas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.GestionContratos.AmpliacionContrato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.GestionContratos.Troncales", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.Seguridad.Modulos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.Seguridad.RelacionalModulosRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.Seguridad.Roles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.Seguridad.Usuarios", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S_CIngenieria.Models.GestionContratos.ODS", b =>
                {
                    ...
                    b.HasOne("S_CIngenieria.Models.GestionContratos.Proyectos", "Proyectos")
                        .WithMany("ODS")
                        .HasForeignKey("ProyectosId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("S_CIngenieria.Models.Seguridad.Usuarios", "SolicitanteUsuarios")
                        .WithMany()
                        .HasForeignKey("SolicitanteCliente")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("S_CIngenieria.Models.Seguridad.Usuarios", "SupervisorUsuarios")
                        .WithMany()
                        .HasForeignKey("Supervisor")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("S_CIngenieria.Models.GestionContratos.Troncales", "Troncales")
                        .WithMany("ODS")
            ...
            modelBuilder.Entity("S_CIngenieria.Models.Seguridad.Permisos", b =>
                {
                    b.HasOne("S_CIngenieria.Models.Seguridad.RelacionalModulosRoles", "RelacionalModulosRoles")
                        .WithMany("Permisos")
            ...
            modelBuilder.Entity("S_CIngenieria.Models.Seguridad.RelacionalModulosRoles", b =>
                {
                    b.HasOne("S_CIngenieria.Models.Seguridad.Modulos", "Modulo")
                        .WithMany()
                        .HasForeignKey("FkModulo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("S_CIngenieria.Models.Seguridad.Roles", "Rol")
                        .WithMany()
                        .HasForeignKey("FkRol")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
